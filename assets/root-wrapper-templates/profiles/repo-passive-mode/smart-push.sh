#!/usr/bin/env bash
#
# smart-push.sh - Project-level wrapper for multi-repository push (repo-passive-mode profile)
...
SKILL_SCRIPT="$ROOT/.agents/kano/kano-git-master-skill/scripts/commit-tools/smart-push.sh"
