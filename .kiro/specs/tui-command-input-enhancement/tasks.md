...
- [x] 2. Implement MetadataCache component
  - [x] 2.1 Create CommandMetadata and OptionMetadata data structures
    - Define structs in new header file `metadata_cache.hpp`
    - Include fields: name, description, subcommands, options, allow_extras
    - _Requirements: 6.4, 6.5_

  - [x] 2.2 Implement metadata extraction from CLI11 app tree
  ...
  - [x] 2.5 Write property test for metadata synchronization
    - **Property 12: Metadata Synchronization**
    - **Validates: Requirements 6.6**
    - Verify commands registered in CLI11 are automatically available
    - _Requirements: 6.6_

- [x] 3. Implement AutocompleteEngine component
  - [x] 3.1 Create InputContext and CandidateItem data structures
  ...
  - [x] 3.2 Implement input parsing logic
  ...
  - [x] 3.8 Write property test for autocomplete candidate matching
  ...
  - [x] 3.9 Write property test for context-aware completion
  ...
  - [x] 3.10 Write property test for candidate list constraints
    - **Property 6: Candidate List Constraints**
    - **Validates: Requirements 3.6, 3.7**
    - Verify alphabetical sorting and max 10 items
    - _Requirements: 3.6, 3.7_

  - [x] 3.11 Write property test for empty candidate list
...
- [x] 5. Implement CommandModeState component
  - [x] 5.1 Create InputBuffer data structure
  ...
  - [x] 5.6 Write property test for input buffer editing invariants
...
- [x] 7. Checkpoint - Command execution ready
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Implement TuiState and mode management
  - [x] 8.1 Create TuiMode enum and TuiState struct
  ...
  - [x] 8.2 Implement mode transition logic
...
- [x] 9. Integrate command input into existing TUI
  ...
  - [x] 9.4 Implement command execution on Enter
  ...
  - [x] 9.5 Write integration tests for event routing
...
- [x] 10. Implement UI rendering components
  - [x] 10.1 Implement RenderInputLine() for command input display
    - Show ':' prompt prefix
  ...
  - [x] 10.2 Implement RenderCandidateList() for autocomplete display
  ...
  - [x] 10.5 Write property test for candidate display completeness
  ...
  - [x] 10.6 Write property test for candidate acceptance
    - **Property 11: Candidate Acceptance Updates Buffer**
    - **Validates: Requirements 5.9**
    - Verify Enter updates buffer with selected candidate
    - _Requirements: 5.9_

- [x] 11. Checkpoint - Basic command input working
  - Ensure all tests pass, ask the user if questions arise.

- [x] 12. Implement CommandPaletteState component
  - [x] 12.1 Create PaletteItem data structure
    - Define struct with name, description, category
    - _Requirements: 8.2, 8.3_

  - [x] 12.2 Implement CommandPaletteState class
  ...
  - [x] 12.5 Implement palette event handling
...
- [x] 19. Final integration and polish
  ...
  - [x] 19.4 Write property test for footer help display
