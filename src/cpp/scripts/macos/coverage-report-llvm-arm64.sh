...
: "${KANO_REPORT_SLUG:=macos-arm64-coverage}"
...
export KANO_TEST_COMMAND='./out/bin/macos-ninja-clang-arm64-coverage/debug/kano_git_tui_tests --reporter junit --out "$KANO_TEST_XML"'
export KANO_TEST_BINARY='./out/bin/macos-ninja-clang-arm64-coverage/debug/kano_git_tui_tests'
