...
SCRIPTS=(
  "repo-management/update-repo.sh"
  "repo-management/clone-with-upstream.sh"
  "repo-management/discover-repos.sh"
  "workspace/update-workspace-repos.sh"
  "workspace/foreach-repo.sh"
  "workspace/status-all-repos.sh"
  "branch-operations/rebase-to-upstream-latest.sh"
  "branch-operations/compare-branches.sh"
  "branch-operations/cherry-pick-batch.sh"
